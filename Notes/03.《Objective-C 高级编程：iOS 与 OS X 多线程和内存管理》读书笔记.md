...
### 4.5. dispatch\_suspend / dispatch\_resume
...
### 4.6. dispatch\_semaphore\_wait / dispatch\_semaphore\_signal
...
### 4.7. Dispatch I/O / Dispatch Data

在读取较大的文件时，如果将文件分成合适的大小并使用并行队列读取的话,应该会比一般的读取速度快不少。 在 GCD 当中能实现这一功能的就是 Dispatch I/O 和 Dispatch Data。
